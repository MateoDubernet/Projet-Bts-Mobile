...
function setup() {
  ...
  for (let i = 0;i<nMoteurs;i++) {
    ...
    bModeAuto.mousePressed(function() {
      sendMessage("mode= auto"); sendMessage("raz");
      manuel = 0;
      auto = 1;
      for (let i = 0;i<nMoteurs;i++) {
        sliders[i].value(0);
